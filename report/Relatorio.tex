...
A entrada do sistemas são os oito sensores frontais do \textit{Pionner}. Todos os sensores são modelados pelas mesmas funções de precedência descritas na figura~\ref{fig:fig1} \cite{Beom:1995}
